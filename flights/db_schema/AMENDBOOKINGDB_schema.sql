...
--
-- Host: localhost    Database: AMENDBOOKINGDB
-- ------------------------------------------------------
...
--
-- Table structure for table `goairamend_booking_report`
--

DROP TABLE IF EXISTS `goairamend_booking_report`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `goairamend_booking_report` (
  `sk` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `airline` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pnr` varchar(20) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `flight_number` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `indigoamend_booking_report`
--

DROP TABLE IF EXISTS `indigoamend_booking_report`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `indigoamend_booking_report` (
  `sk` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `airline` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pnr` varchar(20) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `flight_number` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `spicejetamend_booking_report`
--

DROP TABLE IF EXISTS `spicejetamend_booking_report`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `spicejetamend_booking_report` (
  `sk` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `airline` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pnr` varchar(20) COLLATE utf8_unicode_ci NOT NULL DEFAULT '',
  `flight_number` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
...
-- Dump completed on 2018-04-09 15:56:29
