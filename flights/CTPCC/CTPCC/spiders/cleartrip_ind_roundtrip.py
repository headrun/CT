...
class CleartripIndBrowse(Spider):
	...
	for input_ in requests:
	    ...
	    url = 'https://api.cleartrip.com/air/1.0/search?from=%s&to=%s&depart-date=%s&return-date=%s&adults=1&country=IN&currency=SAR&jsonVersion=1.0'%(from_, to_, date, re_date)
	    headers = {
