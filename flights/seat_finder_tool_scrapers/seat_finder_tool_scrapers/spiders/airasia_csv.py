...
class AirAsiaCsv:
    def csv_process(self):
        ...
        path_to_move = current_path+ '/'+'AIRASIA_CSV/processed'
        path_to_check = current_path +'/'+'AIRASIA_CSV/yet_to_process'
	...
	os.system('scrapy crawl airasia_seatfinder_browse -ajsons="%s" --set HTTP_PROXY="%s"'%(details_dict,ip))
