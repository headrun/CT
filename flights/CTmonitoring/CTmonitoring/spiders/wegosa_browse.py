...
class WegoSaBrowse(Spider):
    name = "wegosa_browse"
    start_urls = ["https://sa.wego.com/en"]

    def __init__(self, *args, **kwargs):
        super(WegoSaBrowse, self).__init__(*args, **kwargs)
	...
	requests = terminal_requests(self.cr_tabe, self.source_name, self.crawl_type, self.limit)
        if requests:
