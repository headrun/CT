...
return_pax_page_depart_loc_path = '//div[@class="booking-details-table"]//table/thead/tr/th[contains(text(), "Return")]/following-sibling::th/text()'

return_pax_page_flight_id_path = '//div[@class="booking-details-table"]//table/thead/tr/th[contains(text(), "Return")]/../../../tbody/tr/td[1]//text()[1]'

return_pax_page_fr_air_path = '//div[@class="booking-details-table"]//table/thead/tr/th[contains(text(), "Return")]/../../../tbody[1]/tr/td[2]//text()'

return_pax_page_to_air_path = '//div[@class="booking-details-table"]//table/thead/tr/th[contains(text(), "Return")]/../../../tbody[1]/tr/td[3]//text()'
