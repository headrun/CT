...
class LoadFiles(object):
	...
	self.path   = "/root/headrun/pbm_scrapers/pbm_scrapers/spiders/OUTPUT/processing"
	self.processed = '/root/headrun/pbm_scrapers/pbm_scrapers/spiders/OUTPUT/processed'
        self.main()
	...
	cmd = 'mysql -uroot ' + '-h localhost' + ' -A ' + 'CLEARTRIP_MAP' + ' --local-infile=1 -e "%s"'
    ...
    def main(self):
	table_names = {'cleartriprt':'ctrt_availability',
			'makemytriprt':'mmtrt_availability',
			'cleartrip':'ct_availability',
			'makemytrip':'mmt_availability',
			'yatra':'yt_availability',
			'yatrart':'ytrt_availability',
			}
